...
touch/mkdir:primeste arborele de subdirectoare, numele fisierului nou, directorul de care apartine
            ...
            functia de inserare este aproape aceeasi cu cea din laborator
            in plus aceasta primeste ca parametru directorul parinte

            mkdir functioneaza aproape identic cu touch

rm/rmdir:   functii recursive care elimina 1 element din arbore
...
cd:         parcurge arborele de directories pana cand il gaseste pe cel cerut
            verificarile se fac in main
            discutia pt .. tot in main

pwd:        apelez recursiv parintii directories si cand ajung la ultimul(root)
            incep sa ii afisez
